...
<div align="center">
 ...
 The original repo: <a href="https://github.com/jeffminsungkim/nestjs-multer-extended" type="_blank">https://github.com/jeffminsungkim/nestjs-multer-extended</a>

## Features

- Multiple files upload to an Amazon S3 bucket
...
**NPM**
```bash
$ npm i -s nestjs-multer
```

**Yarn**
```bash
$ yarn add nestjs-multer
```
...
import { MulterExtendedModule } from 'nestjs-multer';
...
import { AmazonS3FileInterceptor } from 'nestjs-multer';
